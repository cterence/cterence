...
- [cterence/nixos-config](https://github.com/cterence/nixos-config) - Dendritic NixOS config (5 days ago)
...
- [nlewo/comin](https://github.com/nlewo/comin) - GitOps For NixOS Machines (6 days ago)
