...
- [cterence/chip8-go](https://github.com/cterence/chip8-go) - A Golang CHIP-8 interpreeter, supports SUPER-CHIP and XO-CHIP. (5 days ago)
...
- [JohnEarnest/Octo](https://github.com/JohnEarnest/Octo) - A Chip8 IDE (2 weeks ago)
