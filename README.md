...
- [gen2brain/raylib-go](https://github.com/gen2brain/raylib-go) - Go bindings for raylib, a simple and easy-to-use library to enjoy videogames programming. (5 days ago)
- [tsoding/crepl](https://github.com/tsoding/crepl) - C REPL (5 days ago)
- [MadAppGang/dingo](https://github.com/MadAppGang/dingo) -   A meta-language for Go that adds Result types, error propagation (?), and pattern matching while maintaining 100% Go ecosystem compatibility (6 days ago)
- [JohnEarnest/Octo](https://github.com/JohnEarnest/Octo) - A Chip8 IDE (1 week ago)
