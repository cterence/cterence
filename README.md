...
- [padok-team/guacamole](https://github.com/padok-team/guacamole) ([v0.3.2](https://github.com/padok-team/guacamole/releases/tag/v0.3.2), 4 days ago) - Evaluate your IaC quality
...
- [audioling/audioling](https://github.com/audioling/audioling) - Audio player with a focus on self-hosted music server support (2 days ago)
- [clemenko/longhorn_encrypt](https://github.com/clemenko/longhorn_encrypt) -  (4 days ago)
- [GreenmaskIO/greenmask](https://github.com/GreenmaskIO/greenmask) - PostgreSQL database anonymization and synthetic data generation tool (4 days ago)
